    ...
    case 'calculator':
      return (
        <>
          ...
          <Line x1="8" y1="7" x2="16" y2="7" {...s} />
          <Line x1="8" y1="11.5" x2="8" y2="11.5" {...s} />
          <Line x1="12" y1="11.5" x2="12" y2="11.5" {...s} />
          <Line x1="16" y1="11.5" x2="16" y2="11.5" {...s} />
          <Line x1="8" y1="15.5" x2="8" y2="15.5" {...s} />
          <Line x1="12" y1="15.5" x2="12" y2="15.5" {...s} />
          <Line x1="16" y1="15" x2="16" y2="17.5" {...s} />
        </>
      );
    case 'share':
      return (
        <>
          ...
          <Path d="M6 12H5a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-7a1 1 0 0 0-1-1h-1" {...s} />
        </>
      );
    case 'flame':
      return (
        <Path
          d="M12 2c1 3-1.5 4.5-1.5 7A2.5 2.5 0 0 0 13 11c.5-1 .2-2 .2-2 2 1.3 3.3 3.4 3.3 5.8A6.5 6.5 0 1 1 6 14.8C6 10 10 8 12 2Z"
          {...s}
          fill={fill ? color : 'none'}
        />
      );
