...
const makeStyles = (c: ThemeColors) => StyleSheet.create({
  ...
  weekGroceryText: { fontSize: 15, fontWeight: '700', color: c.grayLight },
  ...
  exchangeDivider: { width: 1, backgroundColor: c.border },
  ...
  badgeIconOff: { backgroundColor: c.surfaceAlt, borderWidth: 1.5, borderColor: c.border, borderStyle: 'dashed' },
